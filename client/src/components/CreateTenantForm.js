...
const CreateTenantForm = ({
  ...
  <form className='ui small form'
    ...
    <div className='required inline field'>
      ...
      {username.touched &&
        username.error &&
        <span style={{ color: 'red' }}>{username.error}</span>}
    </div>
    <div className='required inline field'>
    ...
    <div className='inline field'>
      ...
      {middleName.touched &&
        middleName.error &&
        <span style={{ color: 'red' }}>{middleName.error}</span>}
    </div>
    <div className='required inline field'>
    ...
    <button
      ...
      type='submit'
      disabled={Object.keys(errors).length}>Create Tenant</button>
  </form>
)
